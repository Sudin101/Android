...
import com.sudin.jobseeker.publisherfulljobpost;

import java.util.ArrayList;

public class publisher extends RecyclerView.Adapter<publisher.MyViewsHolder>{
    Context context;
    Intent intent;
    String cookie;
    Bitmap bitmap;
    ...
    public publisher(Context context, ArrayList<ltems> jobposts,String cookie) {
    ...
    @NonNull
    @Override
    public publisher.MyViewsHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.sample_rows, viewGroup, false);
        publisher.MyViewsHolder viewHolder = new publisher.MyViewsHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull publisher.MyViewsHolder myViewsHolder, int i) {
