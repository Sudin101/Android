        ...
        switch (v.getId()) {
            ...
            case R.id.btn_addpost:
                if (Validate() == true) {
                    ...
                    Toast.makeText(jobpost.this, "Empty Fields", Toast.LENGTH_LONG).show();
                }
                break;
        }
        ...
        try {
            ...
            imgCall.enqueue(new Callback<Image>() {
                ...
                public void onFailure(Call<Image> call, Throwable t) {
                    Toast.makeText(jobpost.this, "error is" + t.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        } catch (FileNotFoundException e) {
            e.printStackTrace();
    ...
    private void addItem() {
        ...
        voidCall.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(jobpost.this, "Item Added Successfully ", Toast.LENGTH_LONG).show();

                if(response.isSuccessful()){

                    Toast.makeText(jobpost.this, "Sucessful", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(jobpost.this, "Error :" + t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.back:
                ...
                Intent back = new Intent(jobpost.this, DashboardActivity.class);
                startActivity(back);
