...
import com.sudin.jobseeker.Adapter.publisher;
...
public class jobpostpublisher extends AppCompatActivity {
    String cookie;
    Intent intent;
    Button btn_addjob;
    RecyclerView recyclerView;
    ArrayList<ltems> jobdata = new ArrayList<ltems>();
    com.sudin.jobseeker.Adapter.publisher publisherAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jobpostpublisher);
        intent= getIntent();

        cookie = intent.getStringExtra("cookie");
        Toast.makeText(this, "cookie k ho hamro "+ cookie, Toast.LENGTH_SHORT).show();
        btn_addjob = findViewById(R.id.btn_addjob);
        btn_addjob.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(jobpostpublisher.this, jobpost.class);
...
//        postadapter.notifyDataSetChanged();
    ...
    public void populateRecyclerView(ArrayList<com.sudin.jobseeker.models.ltems> postme) {
        ...
        publisherAdapter = new publisher(this, jobdata,cookie);
...
//        postadapter.notifyDataSetChanged();
    ...
    public ArrayList<ltems> getalldata() {
        ...
        Call<ArrayList<ltems>> call = jobpost_interface.getalldata(cookie);

        call.enqueue(new Callback<ArrayList<ltems>>() {
            @Override
            public void onResponse(Call<ArrayList<com.sudin.jobseeker.models.ltems>> call, Response<ArrayList<ltems>> response) {
